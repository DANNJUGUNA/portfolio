...
const About = () => {
  return (
    <div className=' flex-wrap mt-3'>
      <div className='flex items-center justify-center flex-col text-white text-lg mt-11'>
        <p className='font-bold text-xl'> Here is </p>
        <h1 className=' font-bold text-2xl'>ABOUT ME</h1>
     
      </div>
      <div className=' flex justify-center text-black gap-10 text-lg font-semibold py-4'>
      <article className='bg-white/50 border border-white rounded-3xl border-solid hover:text-white hover:bg-inherit flex items-center flex-col px-6 py-3'>
      ...
      <p className=' w-[70%] pl-8 text-white font-semibold text-lg flex justify-center items-center'>
